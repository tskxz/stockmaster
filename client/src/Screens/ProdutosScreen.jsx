                ...
                const fetchProdutos = async () => {
                        try {
                                ...
                                const response = await axios.get(
                                        `http://localhost:8000/api/empresas/produtos/${armazemId}`,
                                        {
                                                headers: {
                                ...
                                const armazemResponse = await axios.get(
                                        `http://localhost:8000/api/empresas/armazem/${armazemId}`,
                                        {
                                                headers: {
                                                        Authorization: `Bearer ${token}`,
                                                },
                                ...
                                setArmazemNome(
                                        armazemResponse.data.data.armazem.nome,
                                );
                                setLoading(false);
